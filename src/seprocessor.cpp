...
void SingleEndProcessor::consumePack(ThreadConfig* config,ReadPack* pack){
    ...
    //    }
    //}
    //data = mRepo.packBuffer[mRepo.readPos]; //��һ��pack
    //mRepo.readPos++;
...
void SingleEndProcessor::producerTask(FastqDataPool &datapool, FastqDataQueue &dataqueue)
{
    ...
    */
    ...
    /*
    int count=0; // data or pack��read�ĸ���
    bool needToBreak = false;
    while(true){
        Read* read = reader.read(); // read()��������һ��read����ָ��
        ...
        data[count] = read;
        count++;
        // configured to process only first N reads ֻ����ǰreadToProcess��read
...
void SingleEndProcessor::consumerTask(ThreadConfig* config, FastqDataPool& datapool, FastqDataQueue& dataqueue)
{
    ...
    //    }
        ...
        while (dq.Pop(id, fqChunk->chunk)) {
            ...
            // ����FastqDataChunk����format ת����pack����ʽ ���洢��mRepo��
